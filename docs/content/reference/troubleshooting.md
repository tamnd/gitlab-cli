...
Most of these come down to network reality or how gitlab serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gitlab rate-limits like any public site. lab already paces
...
Where a surface is gated, lab reads a cookie or token you supply
...
`lab`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what lab actually did
