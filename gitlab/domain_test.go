...
// HTTP behaviour is covered in gitlab_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "gitlab://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("gitlab", "about")
	if err != nil || got.String() != "gitlab://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want gitlab://page/about", got.String(), err)
	}
}
